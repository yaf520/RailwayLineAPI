...
protected:
    //相对里程->相对坐标
    inline Point2d TrsCmlToNE_Relative(double dCml) override { return Point2d(cos(dStartTanAngle), sin(dStartTanAngle)) * dCml; };
    
    double TrsCmlToAngle_Relative(double dCml) override { return dStartTanAngle; }
